...
export default function MekanOnerPage() {
  return (
    <main className="container page-shell submit-page">
      <section className="submit-page-hero">
        <div>
          <p className="submit-page-eyebrow">Katkıda Bulun</p>
          <h1 className="submit-page-title">Mekan Öner</h1>
