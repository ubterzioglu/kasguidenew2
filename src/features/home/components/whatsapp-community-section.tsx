export function WhatsAppCommunitySection() {
  return (
    <section className="whatsapp-community-section" aria-label="WhatsApp Topluluğuna Katıl" id="contact">
      <div className="whatsapp-community-card">
        ...
        <div className="whatsapp-community-content">
          ...
          <p className="whatsapp-community-copy">
            Tabii ki katılmalısın! Diğer tatilciler ve Kaş&apos;ın yerlileriyle bilgilerini paylaş onların deneyimlerinden faydalan!
          </p>
        ...
        <div className="whatsapp-community-footer">
          <div className="footer-social whatsapp-community-social">
            <a
              href="mailto:info@kasguide.de"
              className="footer-social-link whatsapp-community-social-link"
              aria-label="E-posta"
            >
          ...
          <div className="whatsapp-community-meta">
