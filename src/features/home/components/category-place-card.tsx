  ...
  return (
    <Link href={`/mekan/${place.slug}`} className="category-place-card">
      ...
      <div className="category-place-body">
        ...
        {place.guideBadges.length > 0 ? (
          <>
            <span className="category-place-divider" aria-hidden="true" />
            <div className="category-place-badges-row">
              <span className="category-place-badges-label">Kaş Guide</span>
              <PlaceGuideBadges badges={place.guideBadges} variant="card" />
            </div>
          </>
        ) : null}
